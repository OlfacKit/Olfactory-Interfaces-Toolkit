...
if pcb_gen_attchment is not None:
    ...
    elif PCB_attachment_methods != 'ring' and PCB_attachment_methods != 'elastic':
    ...
    if PCB_attachment_methods == 'ring' or PCB_attachment_methods == 'elastic':
        pcb_gen_attchment = rs.MoveObjects(pcb_gen_attchment, trans*-1)
        pcb_gen_attchment = rs.MoveObjects(pcb_gen_attchment, rs.CreateVector(moved_distance,0,0))
...
if OD_PCB_integration:
    ...
    if od_gen_attchment is not None:
        ...
        elif OD_attachment_methods != 'ring' and OD_attachment_methods != 'elastic':
